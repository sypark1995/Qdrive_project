...
public class OutletPickupDoneTrackingNoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (item.isScanned()) {
            ...
            layout_outlet_pickup_done_tracking_no_item.setBackgroundResource(R.drawable.custom_background_barcode_active);
            ...
            layout_outlet_pickup_done_tracking_no_item.setBackgroundResource(R.drawable.custom_background_barcode_inactive);
