...
public class DeviceListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_capture_bluetooth_scan_devices.setOnClickListener(v -> doDiscovery());

        btn_capture_bluetooth_cancel.setOnClickListener(v -> {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.item_device_name);
