...
class ListNotInHousedAdapter(var result: ArrayList<NotInHousedResult>) :
    ...
    override fun getGroupView(
        ...
        val layout_not_in_parcels_item_card_view =
            view.findViewById<LinearLayout>(R.id.layout_not_in_parcels_item_card_view)
        val text_not_in_parcels_item_pickup_no =
            view.findViewById<TextView>(R.id.text_not_in_parcels_item_pickup_no)
        val text_not_in_parcels_item_seller_name =
            view.findViewById<TextView>(R.id.text_not_in_parcels_item_seller_name)
        val img_not_in_parcels_item_up_icon =
            view.findViewById<ImageView>(R.id.img_not_in_parcels_item_up_icon)
        val text_not_in_parcels_item_address =
            view.findViewById<TextView>(R.id.text_not_in_parcels_item_address)
        val text_not_in_parcels_item_desired_date =
            view.findViewById<TextView>(R.id.text_not_in_parcels_item_desired_date)
        val text_not_in_parcels_item_qty =
            view.findViewById<TextView>(R.id.text_not_in_parcels_item_qty)
        val text_not_in_parcels_item_not_processed_qty =
            view.findViewById<TextView>(R.id.text_not_in_parcels_item_not_processed_qty)
        ...
        try {
            val date = SimpleDateFormat(
                "MMM dd yyyy HH:mm",
                Locale.ENGLISH
            ).parse(item.pickup_date) //"Jul 24 2018  4:01PM"
            ...
            text_not_in_parcels_item_desired_date.text =
                text_not_in_parcels_item_desired_date.resources.getString(R.string.text_error)
            e.printStackTrace()
        }
    ...
    override fun getChildView(
        ...
        val layout_not_in_parcels_child_view =
            view.findViewById<LinearLayout>(R.id.layout_not_in_parcels_child_view)
        val text_not_in_parcels_child_scanned_no =
            view.findViewById<TextView>(R.id.text_not_in_parcels_child_scanned_no)
        val text_not_in_parcels_child_amount =
            view.findViewById<TextView>(R.id.text_not_in_parcels_child_amount)
        val text_not_in_parcels_child_currency =
            view.findViewById<TextView>(R.id.text_not_in_parcels_child_currency)
        ...
        if (sub_size - 1 == child_position) {
            ...
            layout_not_in_parcels_child_view.setBackgroundColor(
                layout_not_in_parcels_child_view.resources.getColor(
                    R.color.white
                )
            )
        }
