 ...
 * @editor krm0219
 */
public class CustomNotUploadAdapter extends BaseExpandableListAdapter {
    String TAG = "CustomNotUploadAdapter";
    ...
    CustomNotUploadAdapter(Context context, ArrayList<RowItemNotUpload> rowItem, AdapterInterface listener) {
