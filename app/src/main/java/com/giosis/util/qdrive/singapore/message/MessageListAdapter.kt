...
import com.giosis.util.qdrive.singapore.databinding.ItemMessageListBinding
import java.util.*

class MessageListAdapter(
    private var called: String,
    private val mItems: ArrayList<MessageListResult>?
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            holder.binding.textMessage.text =
                Html.fromHtml(mItems[position].message, Html.FROM_HTML_MODE_LEGACY)
        } else {
