...
public class SQLitePlugin extends CordovaPlugin {
    ...
    public void onDestroy() {
        ...
        /*while (!dbrmap.isEmpty()) {
            ...
            Log.e("CONSOLE", "SQLitePlugin.java  onDestroy() " + dbname);
    ...
    private void startDatabase(String dbname, JSONObject options, CallbackContext cbc) {
        ...
        if (r != null) {
            ...
            Log.e("CONSOLE", "SQLiteplugin.java  startDatabase : " + dbname + " not null");
            // NO LONGER EXPECTED due to BUG 666 workaround solution:
            cbc.error("INTERNAL ERROR: database already open for db name: " + dbname);
        } else {

            Log.e("CONSOLE", "SQLiteplugin.java  startDatabase : " + dbname + " null");
    ...
    private SQLiteAndroidDatabase openDatabase(String dbname, CallbackContext cbc, boolean old_impl) throws Exception {
        try {
            ...
            Log.e("CONSOLE", "krm0219 Open sqlite db: " + dbfile.getAbsolutePath() + " / " + old_impl);
            old_impl = true;
    ...
    private void closeDatabase(String dbname, CallbackContext cbc) {
        ...
        Log.e("CONSOLE", "SQLitePlugin.java  test() " + dbrmap.size());

        //
        DBRunner r = dbrmap.get(dbname);
        if (r != null) {

            Log.e("CONSOLE", "SQLiteplugin.java  closeDatabase : " + dbname + "  not null");
            try {
            ...
            Log.e("CONSOLE", "SQLiteplugin.java  closeDatabase : " + dbname + "  null");
            if (cbc != null) {
                cbc.success();
            }
        }
    ...
    private class DBRunner implements Runnable {
        ...
        public void run() {
            ...
            try {
                Log.e("CONSOLE", "SQLitePlugin.java  run()");
                this.mydb = openDatabase(dbname, this.openCbc, this.oldImpl);
            } catch (Exception e) {

                Log.e("CONSOLE", "SQLitePlugin.java  run() Exception : " + e.toString());
            ...
            if (dbq != null && dbq.close) {
                try {
                    ...
                    //Log.e("CONSOLE", "SQLitePlugin.java  HERE remove");
