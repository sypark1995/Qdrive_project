...
public class SmartRouteExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        img_route_master_google.setOnClickListener(v -> {
            webview_route_master_map.setWebViewClient(new MyWebClient(v.getContext()));
    ...
    private class MyWebClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (isIntent(url)) {
                ...
                if (isExistInfo(intent, mContext) || isExistPackage(intent, mContext)) {
                    return start(intent, mContext);

                } else {
                    gotoMarket(intent, mContext);
                }
