...
import com.giosis.library.databinding.ItemCaptureScannedBinding
import com.giosis.library.list.BarcodeData
import com.giosis.library.util.BarcodeType
import java.util.*

class ScannedBarcodeAdapter(var items: ArrayList<BarcodeData>?, private var scanType: String) : RecyclerView.Adapter<ScannedBarcodeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = ItemCaptureScannedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        ...
        if (barcodeNumber != null) {
            ...
            if (barcodeState == "SUCCESS") {
                ...
                mContext?.let {
                    ...
                    holder.binding.textBarcode.setTextSize(TypedValue.COMPLEX_UNIT_PX, it.resources.getDimension(R.dimen.text_size_36px))
                    holder.binding.textBarcode.setTextColor(ContextCompat.getColor(it, R.color.color_303030))
                }
                ...
                if (scanType == BarcodeType.CHANGE_DELIVERY_DRIVER) {
                    ...
                    mContext?.let {
                        ...
                        holder.binding.textBarcode.setTextSize(TypedValue.COMPLEX_UNIT_PX, it.resources.getDimension(R.dimen.text_size_24px))
                    }
                ...
                mContext?.let {
                    ...
                    holder.binding.textBarcode.setTextColor(ContextCompat.getColor(it, R.color.color_909090))
                }
