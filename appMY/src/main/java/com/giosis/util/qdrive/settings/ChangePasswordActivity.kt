...
class ChangePasswordActivity : CommonActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        text_top_title.text = context.resources.getString(R.string.text_title_change_password)
    ...
    private fun changePassword() {
        ...
        alertBuilder.setTitle(context.resources.getString(R.string.text_title_change_password))
        alertBuilder.setMessage(context.resources.getString(R.string.msg_want_change_password))
        ...
        alertBuilder.setPositiveButton(context.resources.getString(R.string.button_ok)) { dialogInterface, _ ->
            ...
            if (isValid) {
                ...
                val changePasswordAsyncTask = ChangePasswordAsyncTask(oldPassword, newPassword)
    ...
    private fun isValidPassword(oldPassword: String, newPassword: String, confirmPassword: String): Boolean {
        ...
        val alertBuilder = AlertDialog.Builder(this)
        alertBuilder.setTitle(context.resources.getString(R.string.text_invalidation))
        ...
        if (oldPassword.isNotEmpty()) {      // 현재 패스워드 입력
            ...
            if (11 <= newPassword.length) {     // 새로운 패스워드 11자리 이상 입력
                ...
                if (patternValid) {  // 비밀번호 유효성
                    ...
                    if (newPassword == confirmPassword) {    // 확인 비밀번호 일치
                        ...
                        alertBuilder.setMessage(context.resources.getString(R.string.msg_same_password_error))
                        alertBuilder.setPositiveButton(context.resources.getString(R.string.button_ok)) { dialogInterface, _ ->
                    ...
                    alertBuilder.setMessage(context.resources.getString(R.string.msg_password_symbols_error))
                    alertBuilder.setPositiveButton(context.resources.getString(R.string.button_ok)) { dialogInterface, _ ->
                ...
                alertBuilder.setMessage(context.resources.getString(R.string.msg_password_length_error))
                alertBuilder.setPositiveButton(context.resources.getString(R.string.button_ok)) { dialogInterface, _ ->
            ...
            alertBuilder.setMessage(context.resources.getString(R.string.msg_empty_password_error))
            alertBuilder.setPositiveButton(context.resources.getString(R.string.button_ok)) { dialogInterface, _ ->
