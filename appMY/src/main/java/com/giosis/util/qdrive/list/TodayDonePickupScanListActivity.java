...
public class TodayDonePickupScanListActivity extends CommonActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new TodayScannedPackingListDownloadHelper.Builder(this, opID, pickup_no)
                .setOnScanPackingListDownloadEventListener(new TodayScannedPackingListDownloadHelper.OnScanPackingListDownloadEventListener() {
                    @Override
    ...
    public void click_add_scan() {
        ...
        Intent intentScan = new Intent(TodayDonePickupScanListActivity.this, CaptureActivity.class);
    ...
    public void click_take_back() {
        ...
        Intent intent = new Intent(TodayDonePickupScanListActivity.this, CaptureActivity.class);
