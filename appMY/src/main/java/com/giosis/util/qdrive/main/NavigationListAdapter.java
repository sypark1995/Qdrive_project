...
public class NavigationListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<NavigationListItem> itemArrayList = new ArrayList<>();
    ...
    public View getGroupView(int position, boolean isExpanded, View convertView, ViewGroup viewGroup) {
        ...
        //
        NavigationListItem item = itemArrayList.get(position);
    ...
    public int getChildrenCount(int i) {
        ...
        if (itemArrayList.get(i).getChild_list() == null) {
            return 0;
        }

        return itemArrayList.get(i).getChild_list().size();
    }


    @Override
    public Object getChild(int i, int i1) {
        return itemArrayList.get(i).getChild_list().get(i1);
    }
    ...
    public View getChildView(int i, int i1, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.nav_list_child_item, null);
        } else {
        ...
        text_nav_list_sub_title.setText(itemArrayList.get(i).getChild_list().get(i1));
    ...
    void addItem(Drawable icon, String title, ArrayList<String> list) {
