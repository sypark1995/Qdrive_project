...
class FCMIntentService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        Log.e("FCM", "onMessageReceived " + remoteMessage.data.size)
        ...
        /*
          ...
          */if (0 < remoteMessage.data.size) {
            ...
            var action_key = remoteMessage.data[PushData.ACTION_KEY]
            var action_value = remoteMessage.data[PushData.ACTION_VALUE]
            ...
            sendNotification(this, title, message, action_key, action_value) // 안드로이드폰에 Noti기능
            ...
            when (action_key) {
                ...
                PushData.SevenEle_TAKEBACK -> {
                    ...
                    try {
                        ...
                        DatabaseHelper.getInstance().delete(
                            ...
                            "invoice_no='$action_value' COLLATE NOCASE"
                        )
                    } catch (e: Exception) {
                ...
                PushData.LAE -> {
                    ...
                    DataUtil.copyClipBoard(this, action_value)
                }
            }
            ...
            if (!action_key.equals(PushData.QX_MSG, ignoreCase = true)) {
                if (!action_key.equals(PushData.QST, ignoreCase = true)) {
                    val bun = Bundle()
                    bun.putString(PushData.TITLE, title)
                    bun.putString(PushData.MESSAGE, message)
                    bun.putString(PushData.ACTION_KEY, action_key)
                    bun.putString(PushData.ACTION_VALUE, action_value)
