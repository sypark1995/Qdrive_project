...
public class scanBarcodeNoListAdapter extends BaseAdapter {
    ...
    scanBarcodeNoListAdapter(Context context, ArrayList<BarcodeData> objects, String mScanType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.scan_input_list_row, null);
        } else {
        ...
        if (barcodeNumber != null) {
            ...
            if (barcodeState.equals("SUCCESS")) {
                ...
                layout_caption_list_item.setBackgroundResource(R.drawable.bg_radius_10_cccccc);
                ...
                if (scanType.equals(BarcodeType.CHANGE_DELIVERY_DRIVER)) {
                    ...
                    layout_caption_list_item.setBackgroundResource(R.drawable.bg_radius_5_ffcc00);
                }
            } else if (barcodeState.equals("FAIL")) {

                layout_caption_list_item.setBackgroundResource(R.drawable.bg_radius_10_dedede);
