...
public class DeliveryDoneUploadHelper {
    private String TAG = "DeliveryDoneUploadHelper";
    ...
    public static class Builder {
        ...
        Builder setOnServerUploadEventListener(OnServerUploadEventListener eventListener) {
    ...
    class DeliveryUploadTask extends AsyncTask<Void, Integer, ArrayList<StdResult>> {
        ...
        private StdResult requestServerUpload(String assignNo) {
            ...
            try {
                ...
                job.accumulate("del_channel", "QR");        // 업로드 채널: Qdrive Realtime
