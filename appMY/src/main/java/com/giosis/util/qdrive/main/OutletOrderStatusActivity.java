...
public class OutletOrderStatusActivity extends CommonActivity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    void setConditionArrayList(String condition) {
     ...
     /*   opID = "7Eleven.Ajib";
        ...
        if (condition.equals(getResources().getString(R.string.text_outlet_status_1))) {
            ...
            new OutletOrderStatusDownloadHelper.Builder(this, opID, officeCode, deviceID, 1).setOnOutletStatusDownloadListener(
                    new OutletOrderStatusDownloadHelper.OnOutletStatusDownloadListener() {
            ...
            new OutletOrderStatusDownloadHelper.Builder(this, opID, officeCode, deviceID, 2).setOnOutletStatusDownloadListener(
                    new OutletOrderStatusDownloadHelper.OnOutletStatusDownloadListener() {
            ...
            new OutletOrderStatusDownloadHelper.Builder(this, opID, officeCode, deviceID, 3).setOnOutletStatusDownloadListener(
                    new OutletOrderStatusDownloadHelper.OnOutletStatusDownloadListener() {
    ...
    private int dpTopx() {
        ...
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (float) 300, context.getResources().getDisplayMetrics());
    }
