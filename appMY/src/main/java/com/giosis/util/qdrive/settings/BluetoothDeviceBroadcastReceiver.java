    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (action != null) {
            switch (action) {
                case BluetoothDevice.ACTION_FOUND: {     // 불루트스 기기 검색됨.
                    ...
                    if (device != null && device.getBondState() != BluetoothDevice.BOND_BONDED) {
                        if (device.getName() != null && !device.getName().equals("")) {
                            ...
                            // NOTIFICATION.
                            // 2019.11  Print 기기만 선택되도록 'Major' 추가   (Q80 프린트의 경우 IMAGING, UNCATEGORIZED 두가지로 검색됨)
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_STARTED: {   // 블루트스 기기 검색 시작
                ...
                case BluetoothDevice.ACTION_ACL_DISCONNECTED: {      // 블루투스 기기 연결 끊어짐.
                    ...
                    if (BluetoothDeviceData.connectedPrinterAddress != null) {
                        // [Connected Device] 연결이 끊어졌을 때 (프린트 전원 OFF)
                ...
                // 2020.06  단순하게 List view만 바뀌도록 수정
