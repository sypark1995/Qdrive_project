...
public class ModifyDeviceInfoActivity extends CommonActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strDevice = getIntent().getStringExtra("address");
    ...
    public void modifyConfirmClick() {
        ...
        if (rename.equals("")) {
            Toast.makeText(context, context.getResources().getString(R.string.msg_device_name_info), Toast.LENGTH_SHORT).show();
            return;
        }

        BluetoothDeviceData.setDeviceAliasName(device, rename);
        setResult(RESULT_OK);
        finish();
    }
